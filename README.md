# Soen342 Project : Train Route Search and Scheduling System
...
## Database  
We used postgresql as our database and the queries are located in the database folder specifically in the file called schema.sql  
